...
class TestConfigModels:
    ...
    def test_llm_config_defaults(self):
        ...
        # [MIGRATION anthropic→openai] provider/model を openai に統一
    ...
    def test_grace_config_defaults(self):
        ...
        # [MIGRATION anthropic→openai] provider を openai に統一
...
class TestConfigLoader:
    ...
    def test_load_defaults_when_no_file(self):
        ...
        # [MIGRATION anthropic→openai] デフォルトモデルを gpt-5-mini に統一
