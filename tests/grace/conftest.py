...
# 環境変数設定（テスト用）
# [MIGRATION anthropic→openai] LLM provider/API key を openai に統一
...
def mock_llm_client():
    ...
    with patch("openai.OpenAI") as mock:
        ...
        # responses.create のモック
        mock_response = MagicMock()
        mock_response.output_text = '{"original_query": "test", "complexity": 0.5, "estimated_steps": 2, "requires_confirmation": false, "steps": [], "success_criteria": "test"}'
